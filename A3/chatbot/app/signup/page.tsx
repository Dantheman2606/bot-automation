    ...
    <div className="min-h-screen flex items-center justify-center bg-black text-white relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-10 space-y-8 border border-white/10 rounded-3xl bg-black/50 backdrop-blur-xl relative z-10 shadow-2xl shadow-white/5">
        <div className="text-center space-y-3">
          <div className="inline-block px-3 py-1 border border-white/20 text-xs tracking-widest uppercase mb-2">
            Initialization
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="name" className="block text-xs font-light tracking-wider uppercase text-white/70 mb-2">
              Name
            </label>
            <input
              id="name"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-xs font-light tracking-wider uppercase text-white/70 mb-2">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
